...
type CategoryService interface {
	...
	CreateCategory(createRequest *product.CreateCategoryRequest, authorId string) (*product.CreateCategoryResponse, error)
	
	// UpdateCategory actualiza una categoría existente
	UpdateCategory(id string, updateRequest *product.UpdateCategoryRequest) (*product.UpdateCategoryResponse, error)
